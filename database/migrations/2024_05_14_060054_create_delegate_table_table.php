...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('delegate_table', function (Blueprint $table) {
            ...
            $table->string('del_govt1', 25)->nullable();
            $table->string('del_govno1', 50)->nullable();
            ...
            $table->string('del_govt2', 25)->nullable();
            $table->string('del_govno2', 50)->nullable();
            ...
            $table->string('del_govt3', 25)->nullable();
            $table->string('del_govno3', 50)->nullable();
            ...
            $table->string('del_govt4', 25)->nullable();
            $table->string('del_govno4', 50)->nullable();
